  ...
  <body>
				...
				<div class="modal-content">
				      <div class="modal-header" >
				      	<button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
		       			<h4 class='modal-title' id='myModalLabel'>添加/修改黑名单信息</h4>
				      </div>
				      <div class="modal-body">
				      	<form id='whiteform' class='form-horizontal' role='form'>
						    <div class='row'>
							  ...
							  <input type="hidden" name="processGroupPageModel.type" value="0"/>
							  <div class='form-group' id='addinput'>
							    	<div class='col-sm-offset-3 col-sm-5' >
							    		<button type="button" class='col-sm-12 btn btn-info' id="addport">添加黑名单</button>   
							  		</div>
							  </div>
							  <div id="portgroup"> 
							  </div>
	...
	<script type="text/javascript">
		...
		$("#whiteList").bootgrid({
	    	ajax: true,
	        post: function (){},
	        url: "${ctx}/json/processGroupAction!findBlackGroupByPage.action",
	        selection: true,
	        multiSelect: true,
	        rowSelect:true,
	        rowCount:10,
		...
		function save(){
			...
			$.post('${ctx}/json/processGroupAction!checkBlackNameExist.action',{'name':name},function(datas){
				if(savaState=="新增"){
						...
						return false;
						 ...
						 if(datas.success==true){
							...
							$.ajax({
									...
									data:{"processGroupPageModel.type":0,"processGroupPageModel.name":$("#name").val(),"processGroupPageModel.remark":$("#remark").val(),"processGroupPageModel.itemList":items},
