...
!function(a, b, c) {
    ...
    function g() {
        ...
        c = this.options.post;
        return c = a.isFunction(c) ? c() : c,
        this.options.requestHandler(a.extend(!0, b, c))
    }
    function h(b) {
    ...
    function j() {
        this.element.trigger("initialize" + H),
        m.call(this),
        this.selection = this.options.selection && null != this.identifier,
        o.call(this),
        q.call(this),
        C.call(this),
        A.call(this),
        r.call(this),
        n.call(this),
        this.element.trigger("initialized" + H)
    }
    function k(a) {
    ...
    function m() {
        ...
        c.children().each(function() {
            ...
            b.columns.push(f),
            null != f.order && (b.sortDictionary[f.id] = f.order),
    ...
    function n() {
        ...
        function d(a, b) {
            e.currentRows = a,
            p.call(e, b),
            e.options.keepSelection || (e.selectedRows = []),
            y.call(e, a),
            t.call(e),
            v.call(e),
            e.element._bgBusyAria(!1).trigger("loaded" + H,[a])
        }
        var e = this;
        if (this.element._bgBusyAria(!0).trigger("load" + H), F.call(this), this.options.ajax) {
            ...
            var j = {
                ...
                success: function(b) {
                    ...
                    b = e.options.responseHandler(b),
                    e.current = b.current,
                    d(b.rows, b.total)
                },
                error: function(a, b, c) {
                    e.xqr = null,
                    "abort" !== b && (u.call(e), e.element._bgBusyAria(!1).trigger("loaded" + H))
                }
            };
            j = a.extend(this.options.ajaxSettings, j),
            this.xqr = a.ajax(j)
        } else {
            var k = this.searchPhrase.length > 0 ? this.rows.where(c) : this.rows,
            l = k.length; - 1 !== this.rowCount && (k = k.page(this.current, this.rowCount)),
    ...
    function o() {
        if (!this.options.ajax) {
            ...
            p.call(this, this.rows.length),
            G.call(this)
        }
    }
    function p(a) {
        this.total = a,
        this.totalPages = -1 === this.rowCount ? 1 : Math.ceil(this.total / this.rowCount)
    }
    function q() {
        ...
        0 === this.element.children("tbody").length && this.element.append(b.body),
        1 & this.options.navigation && (this.header = a(b.header.resolve(f.call(this, {
            id: this.element._bgId() + "-header"
        }))), c.before(this.header)),
        2 & this.options.navigation && (this.footer = a(b.footer.resolve(f.call(this, {
                ...
                if (g.visibleInSelection) {
                    ...
                    function(b) {
                        ...
                        if (!e.prop("disabled")) {
                            ...
                            d.parents(m).find(j + ":has(" + k + ":checked)")._bgEnableAria(f).find(k)._bgEnableField(f),
                            c.element.find("tbody").empty(),
                            C.call(c),
                            n.call(c)
                        }
                    });
    ...
    function u() {
        ...
        this.selection && (c += 1),
        a.html(b.noResults.resolve(f.call(this, {
            columns: c
        })))
    }
    function v() {
        if (0 !== this.options.navigation) {
            ...
            if ( - 1 !== this.rowCount && c.length > 0) {
                ...
                o = i >= n ? n: i;
                w.call(this, j, "first", "&laquo;", "first")._bgEnableAria(g > 1),
                w.call(this, j, "prev", "&lt;", "prev")._bgEnableAria(g > 1);
                for (var p = 0; o > p; p++) {
                    var q = p + m;
                    w.call(this, j, q, q, "page-" + q)._bgEnableAria()._bgSelectAria(q === g)
                }
                0 === o && w.call(this, j, 1, 1, "page-1")._bgEnableAria(!1)._bgSelectAria(),
                w.call(this, j, "next", "&gt;", "next")._bgEnableAria(i > g),
                w.call(this, j, "last", "&raquo;", "last")._bgEnableAria(i > g),
                E.call(this, c, j)
            }
        }
    }
    function w(b, c, d, e) {
        ...
        l = a(i.paginationItem.resolve(k)).on("click" + H, h(j.paginationButton),
        function(b) {
            b.stopPropagation(),
            b.preventDefault();
            var c = a(this),
        ...
        if (a.isArray(e)) {
            ...
            function(b, e) {
                var g = a(i.actionDropDownItem.resolve(f.call(d, {
                    text: c(e),
                    action: e
                })))._bgSelectAria(e === d.rowCount).on("click" + H, o,
                function(b) {
                    b.preventDefault();
                    var e = a(this),
                    f = e.data("action");
        ...
        if (b.length > 0) {
            ...
            function(b, g) {
                ...
                if (c.selection) {
                    ...
                    i = i && m,
                    m && (l += d.selected, k += ' aria-selected="true"')
                }
                ...
                l.length > 0 && (k += ' class="' + l + '"'),
                j += e.row.resolve(f.call(c, {
                    attr: k,
                    cells: h
                }))
            }),
            c.element.find("thead " + h(c.options.css.selectBox)).prop("checked", i),
            g.html(j),
            z.call(this, g)
        } else u.call(this)
    }
    function z(b) {
        ...
        this.selection && b.off("click" + H, d).on("click" + H, d,
        function(b) {
            b.stopPropagation();
            var d = a(this),
        ...
        b.off("click" + H, "> tr").on("click" + H, "> tr",
        function(b) {
            b.stopPropagation();
            var d = a(this),
            ...
            c.selection && c.options.rowSelect && (d.hasClass(c.options.css.selected) ? c.deselect([e]) : c.select([e])),
            c.element.trigger("click" + H, [c.columns, f])
        })
    }
    function A() {
        if (0 !== this.options.navigation) {
            ...
            if (g.length > 0) {
                ...
                function(c) {
                    c.stopPropagation();
                    var d = a(this).val(); (l !== d || 13 === c.which && "" !== d) && (l = d, (13 === c.which || 0 === d.length || d.length >= i.options.searchSettings.characters) && (b.clearTimeout(k), k = b.setTimeout(function() {
                        B.call(i, d)
                    },
    ...
    function C() {
        ...
        if (this.selection && this.options.multiSelect) {
            var l = h(d.selectBox);
            c.off("click" + H, l).on("click" + H, l,
            function(c) {
                c.stopPropagation(),
                a(this).prop("checked") ? b.select() : b.deselect()
            })
        }
    }
    function D(a) {
        ...
        f = a.find(c);
        if (this.options.multiSort || (a.parents("tr").first().find(c).removeClass(b.iconDown + " " + b.iconUp), this.sortDictionary = {}), e && "asc" === e) this.sortDictionary[d] = "desc",
        f.removeClass(b.iconUp).addClass(b.iconDown);
        else if (e && "desc" === e) if (this.options.multiSort) {
            var g = {};
            for (var i in this.sortDictionary) i !== d && (g[i] = this.sortDictionary[i]);
            this.sortDictionary = g,
            f.removeClass(b.iconDown)
        } else this.sortDictionary[d] = "asc",
        f.removeClass(b.iconDown).addClass(b.iconUp);
        else this.sortDictionary[d] = "asc",
        f.addClass(b.iconUp)
    }
    function E(b, c) {
    ...
    function F() {
        ...
        b.setTimeout(function() {
            if ("true" === a.element._bgAria("busy")) {
                ...
                a.selection && (h += 1),
                d.html(b.loading.resolve(f.call(a, {
                    columns: h
                }))),
    ...
    I = function(b, c) {
        ...
        I.defaults, this.element.data(), c);
        ...
        this.selection = !1,
        this.converter = null,
        this.rowCount = a.isArray(d) ? d[0] : d,
        this.rows = [],
        this.searchPhrase = "",
        this.selectedRows = [],
        this.sortDictionary = {},
    ...
    if (I.defaults = {
        ...
        templates: {
            ...
            header: '<div id="{{ctx.id}}" class="{{css.header}}"><div class="row"><div class="col-sm-6 actionBar" id="headerRow"><p class="{{css.search}}"></p></div></div></div>',
    ...
    I.prototype.append = function(a) {
        if (this.options.ajax);
            ...
            k.call(this, b),
            n.call(this),
            this.element.trigger("appended" + H, [b])
        }
        return this
    },
    I.prototype.clear = function() {
        if (this.options.ajax);
            ...
            this.total = 0,
            n.call(this),
            this.element.trigger("cleared" + H, [b])
        }
        return this
    },
    I.prototype.destroy = function() {
        return a(b).off(H),
        1 & this.options.navigation && this.header.remove(),
        2 & this.options.navigation && this.footer.remove(),
    ...
    I.prototype.remove = function(a) {
        if (null != this.identifier) {
            if (this.options.ajax);
                ...
                this.current = 1,
                n.call(this),
                this.element.trigger("removed" + H, [c])
            }
        }
        return this
    },
    ...
    I.prototype.deselect = function(b) {
        if (this.selection) {
            ...
            for (var c, d, e, f = []; b.length > 0;) if (c = b.pop(), e = a.inArray(c, this.selectedRows), -1 !== e) for (d = 0; d < this.currentRows.length; d++) if (this.currentRows[d][this.identifier] === c) {
                f.push(this.currentRows[d]),
                this.selectedRows.splice(e, 1);
                break
            }
            if (f.length > 0) {
        ...
        String.prototype.resolve = function(b, c) {
            ...
            function(b, e) {
                if (null != e && "function" != typeof e) if ("object" == typeof e) {
                    ...
                    J && J[b] && "function" == typeof J[b] && (e = J[b](e)),
                    b = c ? c.join(".") + "." + b: b;
    ...
    a.fn.bootgrid = function(b) {
        ...
        e = this.each(function(e) {
            ...
            g = f.data(H),
            h = "object" == typeof b && b;
            if ((g || "destroy" !== b) && (g || (f.data(H, g = new I(this, h)), j.call(g)), "string" == typeof b)) if (0 === b.indexOf("get") && 0 === e) d = g[b].apply(g, c);
            else if (0 !== b.indexOf("get")) return g[b].apply(g, c)
        });
        return "string" == typeof b && 0 === b.indexOf("get") ? d: e
    },
    a.fn.bootgrid.Constructor = I,
    a.fn.bootgrid.noConflict = function() {
        return a.fn.bootgrid = K,
        this
    },
